package eu.kanade.tachiyomi.extension.th.mangazaa
...
@Source
abstract class Mangazaa : KeiSource() {
    ...
    companion object {
        ...
        private val dateFormat = DateTimeFormatter.ofPattern("MMMM d, uuuu", Locale("th"))
    }
}
